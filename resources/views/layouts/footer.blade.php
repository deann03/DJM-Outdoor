<footer class="bg-white/70 backdrop-blur-md shadow mt-8">
    <div class="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-700 text-center md:text-left">
